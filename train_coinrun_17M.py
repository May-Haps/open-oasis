"""
Scaling ablation — ~18M parameter CoinRun world model.
...
from model.dit import CoinRunWorldModel, CoinRunWorldModelSmall, DiT
...
def main(args):
    ...
    raw_model = DiT(
        ...
        hidden_size=288, depth=6, num_heads=8,
    ...
    # optimize_ddp=False avoids graph breaks on DDP gradient broadcast
